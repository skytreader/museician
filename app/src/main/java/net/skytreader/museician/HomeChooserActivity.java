    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (permissionStatus == PackageManager.PERMISSION_DENIED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)){
                ...
                ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, HomeChooserActivity.PERMISSIONS_REQUEST_CODE);
            }
        }
    }
        ...
        switch(requestCode){
            case HomeChooserActivity.PERMISSIONS_REQUEST_CODE: {
                if (grantResults.length > 0 && grantResults[0] != PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast t = Toast.makeText(c, "Please grant file access to Museician. Functionality might be limited otherwise.", Toast.LENGTH_SHORT);
                    t.show();
                }
            }
        }
